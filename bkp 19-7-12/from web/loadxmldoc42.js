  ...
  for (i=0;i<basenode.childNodes.length;i++)
   {
	  ...
	  ret++;
	  //document.write("<input type='button' id='"+ basenode.childNodes[i].getAttribute("id") +"' value='"+ basenode.childNodes[i].childNodes[1].childNodes[0].nodeValue + "' onclick='drillDown( &quot;"+ basenode.childNodes[i].getAttribute('id') +"&quot;)'><br/>"); // value of first child of label
	  oo=document.getElementsByTagName("Form")[0].childNodes[ret];
	  oo.getAttributeNode("id").nodeValue=basenode.childNodes[ret].getAttribute("id");
	  oo.getAttributeNode("value").nodeValue=basenode.childNodes[ret].childNodes[1].childNodes[0].nodeValue;
	  oo.getAttributeNode("onclick").nodeValue="drillDown( '"+ basenode.childNodes[ret].getAttribute('id') +"')";
	  }
