  ...
  for (i=0;i<basenode.childNodes.length;i++)
   {
	  ...
	  oo.getAttributeNode("id").nodeValue=basenode.childNodes[i+3].getAttribute("id");
	  oo.getAttributeNode("value").nodeValue=basenode.childNodes[i+3].childNodes[1].childNodes[0].nodeValue;
	  oo.getAttributeNode("onclick").nodeValue="onclick='drillDown( &quot;"+ basenode.childNodes[i+3].getAttribute('id') +"&quot;)'";
	  }
